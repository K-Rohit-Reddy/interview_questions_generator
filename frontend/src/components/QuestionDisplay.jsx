...
const QuestionDisplay = ({
  ...
  const handleDownload = async (includeAnswers) => {
    try {
      ...
      let filename = `interview_report_${jobId}${includeAnswers ? '_with_answers' : ''}.pdf`;
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              {showInitialPreview && (
                <Button
                  ...
                  variant="outline"
                  className="border border-gray-300 text-sm font-medium rounded-md px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                >
                  Hide Questions
                </Button>
              )}
